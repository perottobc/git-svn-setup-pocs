...
call git clone -o mirror %WDIR%\repos\websites.git %WDIR%\devs\per\git_websites
...
call git clone -o mirror %WDIR%\repos\websites.git %WDIR%\devs\ola\git_websites
...
call git clone -o mirror %WDIR%\repos\websites.git %WDIR%\devs\siv\git_websites
