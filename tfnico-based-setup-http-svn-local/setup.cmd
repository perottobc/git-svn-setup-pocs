...
cd %WDIR%/repos
call git svn clone -s http://localhost/svn/svn_repos/company-repo/websites
...
call git svn init --prefix=mirror/ -s http://localhost/svn/svn_repos/company-repo/websites
